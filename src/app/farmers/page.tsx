...
const farmersData: Farmer[] = [
  {
    ...
    imageUrl:
      "https://images.pexels.com/photos/4207783/pexels-photo-4207783.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    joinDate: "2022-03-15",
  },
  {
    id: 2,
    ...
    imageUrl:
      "https://images.pexels.com/photos/5921808/pexels-photo-5921808.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    joinDate: "2021-11-20",
  },
  {
    id: 3,
    ...
    imageUrl:
      "https://images.pexels.com/photos/6603099/pexels-photo-6603099.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    joinDate: "2023-01-10",
  },
  {
    id: 4,
    ...
    imageUrl:
      "https://images.pexels.com/photos/2884144/pexels-photo-2884144.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    joinDate: "2022-08-01",
  },
  {
    id: 5,
    ...
    imageUrl:
      "https://images.pexels.com/photos/7513158/pexels-photo-7513158.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    joinDate: "2023-05-22",
  },
  {
    id: 6,
    ...
    imageUrl:
      "https://images.pexels.com/photos/8965613/pexels-photo-8965613.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    joinDate: "2022-09-30",
  },
];
...
const FarmerCard: React.FC<{ farmer: Farmer }> = ({ farmer }) => (
  <div className="bg-white rounded-lg shadow-md overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 ease-in-out group">
    ...
    <div className="p-5 flex flex-col">
      <h3 className="text-2xl font-bold font-inter text-green-800">
        {farmer.name}
      </h3>
      ...
      <section className="bg-white mt-16">
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">
            ...
            nation. We&apos;d love to help you grow your reach.
          </p>
          <Link
