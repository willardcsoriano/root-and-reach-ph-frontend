...
const MOCK_PRODUCTS: Product[] = [
  {
    ...
    description: 'Crisp, fresh organic romaine lettuce harvested this morning. Perfect for salads.',
  ...
  },
  {
    ...
    description: 'Juicy and sweet Carabao mangoes, ripened naturally under the sun.',
  ...
  },
  {
    ...
    description: 'Premium grass-fed beef sirloin, tender and flavorful, sourced from local ranches.',
  ...
  },
  {
    ...
    description: 'Hand-baked sourdough bread with a perfect chewy interior and crispy crust.',
  ...
  },
  {
    ...
    description: 'Sweet and tangy organic cherry tomatoes, perfect for snacks or salads.',
    producer: 'Green Harvest Farm'
  },
  {
    id: 'prod007',
    ...
    category: 'Fruits',
    price: 70.00, // Corrected from 70.0.0
    image: 'https://placehold.co/400x300/facc15/ffffff?text=Bananas',
    description: 'Locally grown Latundan bananas, naturally sweet and energy-boosting.',
    producer: 'Sunshine Orchards'
  },
  {
    id: 'prod008',
    ...
    description: 'Fresh pasteurized milk from local dairy farms. No preservatives.',
  ...
  },
  {
    ...
    description: 'Locally sourced fresh tilapia, perfect for grilling or frying.',
...
const MOCK_FARMS: Farm[] = [
  {
    ...
    description: 'Dedicated to sustainable and organic farming practices, providing fresh vegetables year-round.',
  ...
  },
  {
    ...
    description: 'Specializing in tropical fruits, known for our sweet Carabao mangoes and various citrus.',
  ...
  },
  {
    ...
    description: 'Our free-range chickens produce the freshest, most flavorful eggs. Committed to animal welfare.',
  ...
  },
  {
    ...
    description: 'Sustainable aquaculture farm providing fresh, high-quality seafood to local markets.',
      ...
      <div className="container mx-auto px-6 py-12 md:py-16">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md mb-8 md:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Search Input */}
            <div>
              <h3 className="text-lg font-semibold text-gray-700 mb-3">Search Products</h3>
            ...
            <div>
              ...
              <div className="relative">
                <ListFilter size={20} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
                <select
        ...
        {filteredAndSortedProducts.length > 0 ? (
          ...
          <div className="text-center py-20 bg-white rounded-xl shadow-md">
            <p className="text-2xl font-semibold text-gray-600 mb-4">No products found matching your criteria.</p>
...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => (
  <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transform hover:-translate-y-2 transition-transform duration-300 ease-in-out">
    ...
    <div className="p-6 text-left">
      ...
      <p className="text-green-700 font-semibold text-md mb-2">{product.producer}</p>
...
const FarmCard: React.FC<FarmCardProps> = ({ farm }) => (
  <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transform hover:-translate-y-2 transition-transform duration-300 ease-in-out">
    <Image
      ...
      alt={farm.name}
      className="w-full h-48 object-cover"
      onError={(e) => { e.currentTarget.src = 'https://placehold.co/600x400/cccccc/333333?text=Farm+Image+Unavailable'; }}
    />
    <div className="p-6 text-left">
      <h3 className="text-xl font-bold text-gray-900 mb-2 line-clamp-1">{farm.name}</h3>
      <p className="text-gray-600 text-sm mb-3 flex items-center">
        <MapPin size={16} className="mr-1 text-green-500" /> {farm.location}
      </p>
      <p className="text-gray-700 text-base mb-4 line-clamp-3">{farm.description}</p>
...
const FarmerCard: React.FC<FarmerCardProps> = ({ farmer }) => (
  <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 flex flex-col items-center text-center p-6 transform hover:-translate-y-2 transition-transform duration-300 ease-in-out">
    <Image
      ...
      onError={(e) => { e.currentTarget.src = 'https://placehold.co/100x100/9ca3af/ffffff?text=Avatar'; }}
    />
    <h3 className="text-xl font-bold text-gray-900 mb-1">{farmer.name}</h3>
    <p className="text-green-700 font-semibold text-md mb-3">{farmer.farmName}</p>
